...
module Standort
  class << self
    ...
    def health_grpc
      @health_grpc ||= Grpc::Health::V1::Health::Stub.new('localhost:9090', :this_channel_is_insecure, channel_args: Standort.user_agent)
    end
  ...
  module V1
    class << self
      ...
      def server_grpc
        @server_grpc ||= Standort::V1::Service::Stub.new('localhost:9090', :this_channel_is_insecure, channel_args: Standort.user_agent)
      end
    end
  end
